...
form.pass2.addEventListener( "keyup", PasswordMatch );
...
function PasswordMatch(e)
{
	...
	{
		form.match.textContent = "matched";
		form.match.style.color = "green";
	}
	else
	{
		form.match.textContent = "not matched";
		form.match.style.color = "red";
	}
}
