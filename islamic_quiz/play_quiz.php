<?php 
	...
	require_once('header.php');
  	...
  	if ( isset($_POST['submit']))
  	{
	    ...
	    if ( empty($id_list))
	    {
	    	echo 'You have visited all questions of this level '.$level;
	    	echo '<br>';
	        ...
	        <div style="width:90%;margin:0px auto;">
	            <h3 id = "center"> <?php echo $row['sawal']; ?></h3>
	                ...
	                <form  method = "POST" id="register" action="<?php echo $_SERVER['PHP_SELF']; ?>">
	                    ...
	                    <input type="radio"  name=" answer" id="A" value="A" checked="checked"><?php echo $row['a']; ?><br>
	                    <input type="radio"  name=" answer" id="B" value="B" ><?php echo $row['b']; ?><br>
	                    <input type="radio"  name=" answer" id="C" value="C" ><?php echo $row['c']; ?><br>
	                    <input type="radio"  name=" answer" id="D" value="D" ><?php echo $row['d']; ?><br>
	             ...
	             <script type="text/javascript" src="play_quiz.js"></script>
	        </body>
	        </html>
